...
function Admissions() {
   ...
   const text = {
      en: {
         ...
         points: ["Classes 1st to 10th", "Limited seats available", "RTE admission as per norms", "Office timing: 9:00 AM to 3:00 PM"],
      ...
      hi: {
         ...
         points: ["कक्षा 1 से 10 तक", "सीमित सीटें उपलब्ध", "RTE प्रवेश नियमों के अनुसार", "कार्यालय समय: सुबह 9 बजे से दोपहर 3 बजे तक"],
