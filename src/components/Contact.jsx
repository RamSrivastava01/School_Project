...
function Contact() {
   ...
   const text = {
      en: {
         ...
         subtitle:
            "For admissions and general enquiries, contact us during office hours.",
         call: "Call Now",
         details: [
      ...
      hi: {
         ...
         subtitle:
            "प्रवेश और सामान्य जानकारी के लिए कार्यालय समय में संपर्क करें।",
         call: "अभी कॉल करें",
         details: [
            ["पता", "सराय राघो, भरखनी, हरदोई, 241123"],
            ["फोन", "+91 99190 29742"],
         ...
         <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-4">
               {text[language].details.map(([label, value]) => (
                  ...
                  >
                     <p className="text-sm font-black uppercase tracking-[0.16em] text-[#0ead69]">
                        {label}
                     </p>
