      ...
      <footer className="bg-[#172033] text-white">
         <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-[1.2fr_0.8fr_1fr]">
            <div>
               ...
               <p className="mt-4 max-w-sm leading-7 text-white/70">
                  Quality education in a safe, disciplined, and student-friendly
                  environment.
               </p>
            </div>

            <div>
               <h4 className="text-sm font-black uppercase tracking-[0.18em] text-[#f7c948]">
                  Quick Links
               </h4>
            ...
            <div>
               ...
               <div className="mt-4 grid gap-2 text-white/72">
                  ...
                  <a href="tel:+919919029742" className="hover:text-white">
                     +91 99190 29742
                  </a>
         ...
         <div className="border-t border-white/10">
            <p className="px-4 py-4 text-center text-sm text-white/60">
               © {new Date().getFullYear()} Shree Pradeep Kumar H.S. School. All
               rights reserved.
            </p>
         </div>
      </footer>
